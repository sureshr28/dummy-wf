		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#trialsureshworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trialsureshworkflowuimodule-display": {
								"semanticObject": "trialsureshworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=trial.suresh.workflowuimodule",
									"url": sap.ui.require.toUrl("trial/suresh/workflowuimodule")
								}
							}
						}
					}
